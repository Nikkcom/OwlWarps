 ...
 * </p>
 */
public class OwlWarpsManager implements CommandExecutor, TabCompleter {
     ...
     */
    public OwlWarpsManager(OwlWarps owlWarps) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            if (command.getName().equalsIgnoreCase("owlwarps")){
